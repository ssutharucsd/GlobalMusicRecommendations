In this project, we built a model to mitigate regional bias in music recommender systems since currently, artists from countries outside of the US/UK are largely underrepresented.
